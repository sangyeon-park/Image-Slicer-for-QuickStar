...
- [How to Use](#how-to-use)
  - [Step 1 — Layout](#step-1--layout)
  - [Step 2 — Image Upload](#step-2--image-upload)
  - [Step 3 — Crop](#step-3--crop)
  - [Step 4 — Slice & Download](#step-4--slice--download)
...
- [주요 기능](#주요-기능)
- [사용 방법](#사용-방법)
  - [Step 1 — 레이아웃 설정](#step-1--레이아웃-설정)
  - [Step 2 — 이미지 업로드](#step-2--이미지-업로드)
  - [Step 3 — 이미지 자르기](#step-3--이미지-자르기)
  - [Step 4 — 분할--다운로드](#step-4--분할--다운로드)
- [파일 구조](#파일-구조)
- [실행 방법](#실행-방법)
- [동기](#동기)
- [한계](#한계)
...
| Tile type | Export processing |
|---|---|
| Checked (special) | Original brightness |
| Unchecked | Brightness 92% + 19.2% white mix\* |
...
│   ├── i18n.js         # Language switching (EN / KO / ZH)
│   ├── step1-grid.js   # Grid layout builder
│   ├── step2-upload.js # Image upload
│   ├── step3-crop.js   # Crop tool
│   └── step4-slice.js  # Slice preview & ZIP download
└── images/
    ├── sample_image.png
    ├── sample_before.png
    ├── sample_after.png
...
*[Image from TheSINZA's YouTube video](https://youtu.be/K2A-MnbvOos?si=j7R-cXSX0ypbjCAU)*
...
**[Sangyeon Park](https://sangyeon-park.github.io/)** — [GitHub](https://github.com/sangyeon-park/Image-Slicer-for-QuickStar)
...
![더신자 유튜브 영상 캡처](images/sample_TheSINZA.jpeg)

*[더신자(TheSINZA) 채널 영상의 이미지](https://youtu.be/K2A-MnbvOos?si=j7R-cXSX0ypbjCAU)*
...
**[박상연](https://sangyeon-park.github.io/)** — [GitHub](https://github.com/sangyeon-park/Image-Slicer-for-QuickStar)
